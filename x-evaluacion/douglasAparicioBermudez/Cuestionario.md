...
1. Seleccione una de las siguientes afirmaciones y explique la razon de su respuesta.
   ...
   - c) No puedo realizar ninguna de las anteriores
    ...
    Resp.- La respuesta correcta es a) porque los modelos abstractos de odoo ofrecen la oportunidad de utilizar como un template básico de funcionalidad permitiendo heredar
            tanto campos como métodos, éstos pudiendo ser reutilizados en otros modelos. O sea sus campos y métodos son heredados por otros modelos concretamente usando 
            _inherit seguido del nombre del modelo abstracto, obteniendo automaticamente todos los campos y métodos definidos en la clase abstracta.
...
Respuesta.- El ejericio número 2 esta en la carpeta trn_examen_ejericio de mi proyecto que lo adjunto.