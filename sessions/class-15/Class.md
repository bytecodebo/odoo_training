...
#### Clase 15
###  Diseño de módulo integrado y documentación de captura de requisitos. Y traducción de módulos

### Introducción

En esta clase se realizara la explicacion de los documentos basicos a utilizar para la captura de requisitos del Cliente,
asi como Actas de Reuniones con el Cliente, y Acta de Entrega de los trabajos desarrollados.
